...
void b3FluidSphSolverOpenCL2::stepSimulation(b3FluidSph** fluids, int numFluids, RigidBodyGpuData& rbData)
{	
	...
	if(GPU_INTEGRATE)
	{
		...
		for(int i = 0; i < numValidFluids; ++i)
		{
			...
			m_fluidRigidInteractor.interact(fluidData, 0, gridData, rbData);
